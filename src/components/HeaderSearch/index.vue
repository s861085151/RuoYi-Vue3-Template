<template>
  <div class="header-search">
    <svg-icon className="search-icon" iconClass="search" @click.stop="click" />
    <el-dialog v-model="show" width="600" @close="close" :showClose="false" appendToBody>
      <el-input
        v-model="search"
      ...
      <div class="result-wrap">
        <el-scrollbar>
          ...
          >
            <div class="left">
              <svg-icon class="menu-icon" :iconClass="item.icon" />
            </div>
            ...
            <svg-icon iconClass="enter" v-show="index === activeIndex" />
          </div>
        </el-scrollbar>
      </div>
    </el-dialog>
