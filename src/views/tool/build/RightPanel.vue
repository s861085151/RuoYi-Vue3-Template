      ...
      <el-scrollbar class="right-scrollbar">
        ...
        >
            ...
            >
              <el-option-group v-for="group in tagList" :key="group.label" :label="group.label">
                <el-option v-for="item in group.options" :key="item.label" :label="item.label" :value="item.tagIcon">
                  <svg-icon class="node-icon" :iconClass="item.tagIcon" style="margin-right: 10px" />
          ...
          <template v-if="activeData.layoutTree">
            ...
            <el-tree :data="[activeData]" :props="layoutTreeProps" nodeKey="renderKey" defaultExpandAll draggable>
              <template #default="{ node, data }">
                <span class="node-label">
                  <svg-icon class="node-icon" :iconClass="data.tagIcon" style="margin-right: 5px" />
                  {{ node.label }}
                </span>
              </template>
            </el-tree>
        ...
        <!-- 表单属性 -->
        <el-form v-show="currentTab === 'form'" labelWidth="90px" labelPosition="top">
...
import { ref, getCurrentInstance, reactive, toRefs, resolveComponent, computed } from 'vue';
