    ...
    <div class="left-board">
      ...
      <el-scrollbar class="left-scrollbar">
        <div class="components-list">
          <div class="components-title"><svg-icon iconClass="component" />输入型组件</div>
          <draggable
            ...
            <template #item="{ element, index }">
              <div :key="index" class="components-item" @click="addComponent(element)">
                <div class="components-body">
                  <svg-icon :iconClass="element.tagIcon" />
                  {{ element.label }}
                </div>
              </div>
            </template>
          </draggable>
          <div class="components-title"><svg-icon iconClass="component" />选择型组件</div>
          <draggable
            class="components-draggable"
          ...
          <div class="components-title"><svg-icon iconClass="component" /> 布局型组件</div>
          <draggable
            class="components-draggable"
