<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="表名称" align="center" prop="tableName" :showOverflowTooltip="true" />
      <el-table-column label="表描述" align="center" prop="tableComment" :showOverflowTooltip="true" />
      <el-table-column label="实体" align="center" prop="className" :showOverflowTooltip="true" />
      <el-table-column
        label="创建时间"
        align="center"
        prop="createTime"
      ...
      <el-table-column
        ...
        :sortOrders="['descending', 'ascending']"
      />
      <el-table-column label="操作" align="center" width="330" className="small-padding fixed-width">
        <template #default="scope">
    ...
    />
    <!-- 预览界面 -->
    <el-dialog :title="preview.title" v-model="preview.open" width="80%" top="5vh" appendToBody class="scrollbar">
...
import { ref, onActivated, toRefs, reactive, getCurrentInstance } from 'vue';
