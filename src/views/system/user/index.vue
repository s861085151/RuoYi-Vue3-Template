<template>
  <div class="app-container">
    ...
    <!-- 添加或修改用户配置对话框 -->
    <el-dialog :title="title" v-model="open" width="600px" appendToBody>
      <el-form :model="form" :rules="rules" ref="userRef" labelWidth="80px">
        <el-row>
          <el-col :span="12">
    ...
    <!-- 用户导入对话框 -->
    <el-dialog :title="upload.title" v-model="upload.open" width="400px" appendToBody>
      <el-upload
        ref="uploadRef"
        :limit="1"
        accept=".xlsx, .xls"
