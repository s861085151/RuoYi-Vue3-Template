<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" width="180" align="center" className="small-padding fixed-width">
        <template #default="scope">
    ...
    <el-dialog :title="title" v-model="open" width="500px" appendToBody>
      <el-form ref="postRef" :model="form" :rules="rules" labelWidth="80px">
        <el-form-item label="岗位名称" prop="postName">
        ...
        <el-form-item label="岗位顺序" prop="postSort">
          <el-input-number v-model="form.postSort" controlsPosition="right" :min="0" />
        </el-form-item>
