<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" v-show="showSearch" :inline="true" labelWidth="68px">
    ...
    <el-table v-loading="loading" :data="roleList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="角色名称" prop="roleName" :showOverflowTooltip="true" width="150" />
      <el-table-column label="权限字符" prop="roleKey" :showOverflowTooltip="true" width="150" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" appendToBody>
      <el-form ref="roleRef" :model="form" :rules="rules" labelWidth="100px">
        <el-form-item label="角色名称" prop="roleName">
        ...
        <el-form-item label="角色顺序" prop="roleSort">
          <el-input-number v-model="form.roleSort" controlsPosition="right" :min="0" />
        </el-form-item>
    ...
    <!-- 分配角色数据权限对话框 -->
    <el-dialog :title="title" v-model="openDataScope" width="500px" appendToBody>
