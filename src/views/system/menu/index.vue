<template>
  <div class="app-container">
    ...
    >
      <el-table-column prop="menuName" label="菜单名称" :showOverflowTooltip="true" width="160"></el-table-column>
      ...
      <el-table-column prop="perms" label="权限标识" :showOverflowTooltip="true"></el-table-column>
      <el-table-column prop="component" label="组件路径" :showOverflowTooltip="true"></el-table-column>
      ...
      <el-table-column label="操作" align="center" width="210" className="small-padding fixed-width">
        <template #default="scope">
    ...
    <!-- 添加或修改菜单对话框 -->
    <el-dialog :title="title" v-model="open" width="680px" appendToBody>
      <el-form ref="menuRef" :model="form" :rules="rules" labelWidth="100px">
        <el-row>
          <el-col :span="24">
          ...
          <el-col :span="12" v-if="form.menuType != 'F'">
            <el-form-item label="菜单图标" prop="icon">
              <el-popover placement="bottom-start" :width="540" trigger="click">
                ...
                <icon-select ref="iconSelectRef" @selected="selected" :activeIcon="form.icon" />
              </el-popover>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="显示排序" prop="orderNum">
              <el-input-number v-model="form.orderNum" controlsPosition="right" :min="0" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="菜单名称" prop="menuName">
