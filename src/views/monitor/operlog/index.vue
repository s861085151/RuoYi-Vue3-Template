<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="系统模块" align="center" prop="title" :showOverflowTooltip="true" />
      ...
      />
      <el-table-column label="操作地址" align="center" prop="operIp" width="130" :showOverflowTooltip="true" />
    ...
    <!-- 操作日志详细 -->
    <el-dialog title="操作日志详细" v-model="open" width="800px" appendToBody>
