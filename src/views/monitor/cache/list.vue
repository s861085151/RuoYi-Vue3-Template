    ...
    <el-row :gutter="10">
      <el-col :span="8">
        <el-card style="height: calc(100vh - 125px)">
          ...
          >
            ...
            <el-table-column label="操作" width="60" align="center" className="small-padding fixed-width">
      ...
      <el-col :span="8">
        <el-card style="height: calc(100vh - 125px)">
          ...
          >
            <el-table-column label="序号" width="60" type="index"></el-table-column>
            <el-table-column label="缓存键名" align="center" :showOverflowTooltip="true" :formatter="keyFormatter">
            </el-table-column>
            <el-table-column label="操作" width="60" align="center" className="small-padding fixed-width">
              <template #default="scope">
