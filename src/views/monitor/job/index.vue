<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务名称" align="center" prop="jobName" :showOverflowTooltip="true" />
      <el-table-column label="任务组名" align="center" prop="jobGroup">
        <template #default="scope">
          <dict-tag :options="sys_job_group" :value="scope.row.jobGroup" />
        </template>
      </el-table-column>
      <el-table-column label="调用目标字符串" align="center" prop="invokeTarget" :showOverflowTooltip="true" />
      <el-table-column label="cron执行表达式" align="center" prop="cronExpression" :showOverflowTooltip="true" />
      ...
      <el-table-column label="操作" align="center" width="200" className="small-padding fixed-width">
        <template #default="scope">
    ...
    <!-- 添加或修改定时任务对话框 -->
    <el-dialog :title="title" v-model="open" width="820px" appendToBody>
      <el-form ref="jobRef" :model="form" :rules="rules" labelWidth="120px">
        <el-row>
          <el-col :span="12">
            <el-form-item label="任务名称" prop="jobName">
    ...
    <el-dialog title="Cron表达式生成器" v-model="openCron" appendToBody destroyOnClose>
      <crontab ref="crontabRef" @hide="openCron = false" @fill="crontabFill" :expression="expression"></crontab>
    </el-dialog>

    <!-- 任务日志详细 -->
    <el-dialog title="任务详细" v-model="openView" width="700px" appendToBody>
