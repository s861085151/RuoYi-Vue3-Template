<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="jobLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="任务组名" align="center" prop="jobGroup" :showOverflowTooltip="true">
        <template #default="scope">
          <dict-tag :options="sys_job_group" :value="scope.row.jobGroup" />
        </template>
      </el-table-column>
      <el-table-column label="调用目标字符串" align="center" prop="invokeTarget" :showOverflowTooltip="true" />
      <el-table-column label="日志信息" align="center" prop="jobMessage" :showOverflowTooltip="true" />
    ...
    <!-- 调度日志详细 -->
    <el-dialog title="调度日志详细" v-model="open" width="700px" appendToBody>
